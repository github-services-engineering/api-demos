#!/usr/bin/env bash
#
# GitHub Organization repository list exporter
# ============================================
#
# Usage:
#
...
#
# ./repo-list-export.sh [options] <orgname>...
#
# Options:
#  -h | --help              Display this help text
#  -a | --array-format      Output the repository list in
#                           "<orgname>/<repo1>","<orgname>/<repo2>" format
